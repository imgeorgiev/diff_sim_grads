...
class BallThrow:
    ...
    def __init__(self, cfg, integrator_class, render=False, adapter="cpu"):
        self.cfg = cfg
        ...
        # type of simulation
        self.model.customized_particle_wall = True
        self.model.customized_particle_ground = False
        # this will decide the position of the wall in simulation
        self.model.customized_wall_x = cfg.wall_x
        self.model.customized_wall_y = cfg.wall_y
    ...
    def compute_loss(self):
        ...
        wp.launch(
            ...
            dim=1,
            inputs=[self.states[-1].particle_q, self.loss],
            device=self.device,
        )
    ...
    def check_grad(self, param):
        ...
        # TODO might need to zero grads here
